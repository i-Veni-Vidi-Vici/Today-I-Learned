...
- ```python
 ...
 - ```python
    # 059
    # 다음 리스트에 저장된 데이터의 개수를 화면에 구해라.
    cook = ["피자", "김밥", "만두", "양념치킨", "족발", "피자", "김치만두", "쫄면", "소시지", "라면", "팥빙수", "김치전"]
    print(len(cook))    #정답 복습완료
    ```
 - ```python
    # 060
    # 다음 리스트의 평균을 출력하라.
...
- ```python
  ...
  print(" ".join(interest))   #정답 ★ join 공부필요 완료
  ```
- ```python
  # 067 join 메서드
  # interest 리스트에는 아래의 데이터가 바인딩되어 있다.
...
- ```python  
  # 073
  # 숫자 1 이 저장된 튜플을 생성하라.
  tuple1 = (1)     # 오답  ,콤마 반드시 붙여야함
  print(tuple1)
  # 정답 tuple = (1,) ★ tuple 공부필요 완료
  ```
- ```python  
  # 074
...
- ```python  
  ...
  interest = ['삼성전자', 'LG전자', 'SK Hynix']   
  print(interest)
  # 정답  data = list(interest) 공부완료
  ```
- ```python  
  # 078
  # 다음 리스트를 튜플로 변경하라.
  interest = ['삼성전자', 'LG전자', 'SK Hynix']
  print(tuple(interest))  #정답
  ```
- ```python  
  # 079 튜플 언팩킹
  # 다음 코드의 실행 결과를 예상하라.
...
- ```python  
  ...
  # (2, 4, 6, 8 ... 98)
  a= tuple(range(2,99,2)) #정답 range 복습 완료
  print(a)
  ```
# 081~090
...
- ```python  
  ...
  *valid_score, _,_ =[8.8, 8.9, 8.7, 9.2, 9.3, 9.7, 9.9, 9.5, 7.8, 9.4]
  print(valid_score)  # 정답 ★ star expression 공부필요 완료
  ```
- ```python  
  # 082
  ...
  print(valid_score) #정답
  ```
- ```python  
  # 083
  # 다음과 같이 10개의 값이 저장된 scores 리스트가 있을 때, start expression을 사용하여 가운데 있는 8개의 값을 valid_score 변수에 바인딩하여라.
  # scores = [8.8, 8.9, 8.7, 9.2, 9.3, 9.7, 9.9, 9.5, 7.8, 9.4]
  a, *valid_score, c = [8.8, 8.9, 8.7, 9.2, 9.3, 9.7, 9.9, 9.5, 7.8, 9.4]
  print(valid_score) #정답
  ```
- ```python  
  # 084 비어있는 딕셔너리
  # temp 이름의 비어있는 딕셔너리를 만들라.
  temp ={}    # 정답 ★ 딕셔너리 공부필요 완료
  ```
- ```python  
  # 085
...
- ```python 
  ...
  # 오답
  # 정답 print(list(icecream.keys()))
  ```
- ```python 
  # 096 딕셔너리 values() 메서드
  # 다음의 딕셔너리에서 values 값으로만 구성된 리스트를 생성하라.
  icecream = {'탱크보이': 1200, '폴라포': 1200, '빵빠레': 1800, '월드콘': 1500, '메로나': 1000}
  print(list(icecream.values()))  #정답
  ```
- ```python 
  # 097 딕셔너리 values() 메서드
  ...
  print(icecream) # 정답 ★ update 공부 필요 완료
  ```
- ```python 
  # 099 zip과 dict
  ...
  # 정답 result = dict(zip(keys, vals))   ★ zip 공부필요 완료
  # print(result)
  ```
- ```python 
  # 100 zip과 dict
