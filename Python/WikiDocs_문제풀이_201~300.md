...
- ```python
  ...
  #         super(자전차,self).__init__(x1,x2)
  #         self.구동계 =x3
  # bicycle = 자전차(2, 100, "시마노")
  # print(bicycle.구동계) #정답 super공부완료
  ```
- ```python
  # 285 클래스 상속
...
- ```python
  ...
  # 035420
  # 정답 
  # f = open("C:/Users/SeongIl/Desktop/매수종목1.txt", mode="wt", encoding="utf-8")
  # f.write("005930\n")
  # f.write("005380\n")
  # f.write("035420")
  # f.close()
...
- ```python
  ...
  # 005380 현대차
  # 035420 NAVER
  # f = open('C:/Users/SeongIl/Desktop/매수종목2.txt', mode='wt',encoding="utf-8")
  # f.write("005930 삼성전자\n")
  # f.write("005380 현대차\n")
...
- ```python
  ...
  # import csv
  # f = open("C:/Users/SeongIl/Desktop/매수종목.csv", mode="wt", encoding="cp949", newline='')
  # writer = csv.writer(f)
...
- ```python
  ...
  # 005380
  # 035420
  #  정답 f = open("C:/Users/SeongIl/Desktop/매수종목1.txt", encoding="utf-8")
  # lines = f.readlines() 
  # codes = []
  # for line in lines:
  #     code = line.strip()  #'\n'
...
- ```python
  ...
  # 005380 현대차
  # 035420 NAVER
  # f = open("C:/Users/SeongIl/Desktop/매수종목2.txt", encoding="utf-8")
  # lines = f.readlines()
  # codes ={}
  # for line in lines:
  #     code= line.split()
